...
const Hero = () => {
    ...
    return (
        ...
        h-auto md:mt-24 text-bgBlack dark:text-white overflow-hidden transition-all duration-300">
            ...
            <div className="hidden md:flex flex-row items-center justify-end md:scale-150 translate-x-44 z-10 md:translate-x-32 lg:translate-x-28 md:translate-y-10 md:-rotate-12 transition-all duration-300 ease-in">
